...
/** BUY-01 — buyer dashboard ServiceHub strip wired to `GET /v1/me/service-leads`. */
export function BuyerServiceHubPanel({
  ...
  if (variant === "page") {
    return (
      <section aria-labelledby="buyer-servicehub-heading">
        ...
        <CardHeader className="flex flex-col gap-3 sm:flex-row sm:items-start sm:justify-between">
          <div className="flex gap-3">
            ...
            <div>
              ...
              <CardDescription>
                Quotes and jobs you start from ServiceHub — status and next steps in one place.
              </CardDescription>
            </div>
          </div>
