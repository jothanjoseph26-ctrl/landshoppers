...
import { providerScopedV1 } from "./provider.js";
...
import { adminServicehubV1, servicesPublicV1 } from "./services.js";
...
v1Routes.route("/provider", providerScopedV1);
v1Routes.route("/admin/whatsapp", adminWhatsappV1);
v1Routes.route("/admin/seo", adminSeoV1);
adminV1.route("/services", adminServicehubV1);
...
v1Routes.route("/services", servicesPublicV1);
